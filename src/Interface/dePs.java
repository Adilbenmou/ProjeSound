 ...
 * @author hp
 */
public class dePs extends javax.swing.JFrame {

    /**
     * Creates new form dePs
     */
        ResultSet rs;
        dbcnx db;
    public dePs() {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(110, 183, 629, 190);
        ...
        jButton1.setBounds(567, 378, 135, 37);

        sup.setFont(new java.awt.Font("Andalus", 2, 18)); // NOI18N
        sup.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/foto/trash.png"))); // NOI18N
        ...
        sup.setBounds(181, 378, 131, 37);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/foto/gvff3.jpg"))); // NOI18N
        jLabel6.setText("jLabel6");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(-30, -20, 960, 520);
   ...
   JOptionPane.showMessageDialog(this, "Selectionne le produit");
        ...
        suppProduit m=new suppProduit (en,no,pr,de);
        m.setVisible(true);
        this.dispose();
}
...
//        re.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dePs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
